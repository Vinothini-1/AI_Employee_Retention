...
const LeaveRecords = () => {
  ...
  // Clear leave records with confirmation
  const clearLeaveRecords = () => {
    if (window.confirm("Are you sure you want to clear all leave records?")) {
      setLeaveRecords([]);
    }
  };
  ...
  return (
    <>
      <div className="container my-5">
        <button className="btn btn-danger my-3" onClick={clearLeaveRecords}>
          Clear Leave Records
        </button>
        {loading ? (
