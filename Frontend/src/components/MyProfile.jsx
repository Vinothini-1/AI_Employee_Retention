...
const EmployeeForm = () => {
  ...
  return (
    <div className="container my-5" style={{ backgroundColor: "lightgrey", borderRadius: "30px" }}>
      <div className="container d-flex gap-3 flex-column flex-md-row align-items-center align-items-md-start justify-content-start">
        ...
        >
          ...
          <button type="submit" className="col btn btn-custom my-3 "  style={{  borderRadius: "10px" }}>
            update
          </button>
        </form>
