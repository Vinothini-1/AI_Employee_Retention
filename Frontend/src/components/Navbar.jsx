...
import AssignTask from "./AssignTasks.jsx";
...
const Navbar = () => {
  ...
  return (
    <nav className="navbar bg-body-tertiary sticky-top" >
      <div className="container"  style={{ backgroundColor: "#0000" }}>
        <button
          className="btn"
          type="button"
        ...
        <div className="d-flex align-items-center justify-content-center">
          <Link
            ...
            to="/myprofile"
          >
            <div className="profile-icon"  style={{ backgroundColor: "lightgrey" }} >
              <img
          ...
          <div className="btn me-3 fs-5" onClick={handleLogout} style={{ backgroundColor: "lightgrey" }}>
        ...
        >
          <div className="offcanvas-header" style={{ backgroundColor: "#C6EDEF" }}>
          ...
          <div className="offcanvas-body" style={{ backgroundColor: "#0000" }} >
